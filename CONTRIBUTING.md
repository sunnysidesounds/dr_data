...
Welcome to ``dr_data`` contributor's guide.
...
If you experience bugs or general issues with ``dr_data``, please have a look
...
You can help improve ``dr_data`` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

``dr_data`` documentation uses Sphinx_ as its main documentation compiler.
...
.. todo:: If your project is hosted on GitHub, you can also mention the following tip:
   ...
   .. tip::
      ...
      propose changes in ``dr_data``'s files. While this mechanism can
...
or Miniconda_::
    ...
    conda create -n dr_data python=3 six virtualenv pytest pytest-cov
    conda activate dr_data
...
#. Clone this copy to your local disk::
    ...
    git clone git@github.com:YourLogin/dr_data.git
    cd dr_data
...
#. Install |pre-commit|_::
   ...
   ``dr_data`` comes with a lot of hooks configured to automatically help the
...
.. _repository: https://github.com/<USERNAME>/dr_data
.. _issue tracker: https://github.com/<USERNAME>/dr_data/issues
.. <-- end -->
